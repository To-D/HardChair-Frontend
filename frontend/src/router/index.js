...
import ConferenceApplication from '@/papers/ConferenceApplication'
import ConferenceVerification from '@/papers/ConferenceVerification'
import ConferenceHome from '@/papers/ConferenceHome'
import ConferenceDetail from '@/papers/ConferenceDetail'
import PaperDetail from '@/papers/PaperDetail'
import Index from '@/papers/Index'
import MessageInbox from '@/papers/MessageInbox'
import MyArkChair from '@/papers/MyArkChair'
