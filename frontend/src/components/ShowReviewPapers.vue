  ...
  <div>
    ...
    >
      ...
      <div class="row">
        ...
        <el-button v-if="paper.status == -1" class="onPageBtn" type="primary" disabled>Reviewed</el-button>
        <el-button v-else class="onPageBtn" type="primary" @click="$router.push({path:'/paper/'+paper.id}) ">Review</el-button>
      </div>
    </el-card>
    <div class="row">
